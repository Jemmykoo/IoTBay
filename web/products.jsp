<%-- Document : products Created on : 08/05/2022, 4:02:16 PM Author : Jemima --%>
                            ...
                            <div>
                                <table class="productsTable">
                                    <tr>
                                        ...
                                        <th>Description</th>
                                        <%if (loggedInUser !=null) { if (loggedInUser.getIsStaff()==true) { %>
                                            <th>Edit</th>
                                            <th>Delete</th>
                                            <% } } %>
                                    </tr>
                                            ...
                                            <%if (loggedInUser !=null) { if (loggedInUser.getIsStaff()==true) {%>
                                                <td>
                                                    <form action="editProduct.jsp" method="get">
                                                        <button name="productId" type="submit"
                                                            value="<%=product.getProductId()%>">Edit</button>
                                                    </form>
                                                </td>
                                                <td>
                                                    </form>
