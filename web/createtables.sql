...
INSERT INTO PAYMENT(PAYMENTMETHOD,NAMEONCARD,CARDNUMBER,EXPIRYDATE,CVV)
VALUES
('Card', 'Ron Weasley', '4622 6300 0013 3464', '06/25', 256),
('Card', 'Albus Dumbledore', '4622 6300 1156 9348', '02/23', 834);
...
INSERT INTO PAYMENTHISTORY(PAYMENTID,PAYMENTMETHOD,DATEOFPAYMENT,AMOUNT,ORDERID)
VALUES
(1000, 'Card', '05/10/2022', 699.99, 10000),
(1001, 'Card', '03/27/2022', 123.45, 10001);
